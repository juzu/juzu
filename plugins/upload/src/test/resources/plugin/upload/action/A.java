...
public class A {
  ...
  @Action
  @Route("/action")
  public Response.View action(FileItem file, String text, @Mapped Bean bean) throws IOException {
    if (file != null) {
  ...
  public Response.Content index() {
    return Response.ok(
        "<form action='" + A_.action(null, null) + "' method='post' enctype='multipart/form-data'>" +
