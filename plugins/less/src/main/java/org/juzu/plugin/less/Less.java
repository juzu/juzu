...
/**
 * This annotation trigger declares a less stylesheet. It triggers the compilation of a less stylesheet when it is processed.
 * by the compiler.
 *
...
public @interface Less
{
   ...
   /**
    * Configure the minification of the stylesheet when they are processed. The stylesheets are not minified
    * by default.
    *
