...
public class TemplateBuilderTestCase extends TestCase
{
   ...
   public void testFoo() throws Exception
   {
      ...
      GroovyTemplateBuilder template = new GroovyTemplateBuilder("template_" + Math.abs(new Random().nextLong()));
      parser.parse("a<%=foo%>c").build(template);
      GroovyTemplate s = template.build();
