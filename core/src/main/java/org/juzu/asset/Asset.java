...
/**
 * <p>Representation of an asset at runtime, an asset can be a reference or a literal value.</p>
 *
 * <p>Asset references are a mere reference to an asset that will be managed by the server, for instance the
 * <code>jquery</code> asset reference an asset for which the developer does not have to provide details.</p>
 *
 * <p>Asset literals provide an explicit asset with a location and an URI that will be used to resolve
 * fully the asset.</p>
 *
