...
class SingletonInstantiationStrategy implements InstantiationStrategy
{
   ...
   /** . */
   private final Map<String, SingletonBean> singletons;

   /** . */
   private final InstantiationStrategy delegate;

   SingletonInstantiationStrategy(InstantiationStrategy delegate, Map<String, SingletonBean> singletons)
   {
   ...
   {
      SingletonBean singleton = singletons.get(beanName);
      if (singleton != null)
      {
