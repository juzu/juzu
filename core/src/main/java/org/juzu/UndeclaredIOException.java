 ...
 * makes the <code>IOException</code> transparent to the developer, for instance we want to void the developer to care about
 * the <code>IOException</code> in this situation:
 *
 * <pre><code>
 ...
 * </pre></code>
 *
 * Instead the {@link org.juzu.template.Template#render()} methods wraps the <code>IOException</code> with this unchecked
