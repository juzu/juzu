...
public class InterpolationTestCase extends AbstractInjectTestCase {

  public InterpolationTestCase(InjectorProvider di) {
    super(di);
  }

  @Test
  public void testCompile() throws Exception {
    CompilerAssert<?, ?> app  = compiler("plugin.asset.interpolation");
    app.option("test_js", "test.js");
