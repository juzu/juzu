 ...
 *
 */
public class AMDWebjarsTestCase extends AbstractAMDTestCase {
  @Deployment(testable = false)
  public static WebArchive createDeployment() {
    WebArchive war = createServletDeployment(true, "plugin.amd.webjars");
  ...
  public void test() throws Exception {
    ...
    assertList(Tools.list("/juzu/assets/juzu/impl/plugin/amd/require.js",
        ...
        "/juzu/assets/plugin/amd/webjars/assets/foo.js",
        "/juzu/assets/webjars!jquery.js"), sources);
    
    String jquery = Tools.read(new URL("http://localhost:8080/juzu/assets/webjars!jquery.js"));
