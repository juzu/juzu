...
public class AMDRequireTestCase extends AbstractAMDTestCase {
  ...
  public void test() throws Exception {
    ...
    String foo = Tools.read(new URL("http://localhost:"+System.getProperty("tomcat.http.port")+"/juzu/assets/plugin/amd/require/assets/foo.js")).trim();
    ...
    String bar = Tools.read(new URL("http://localhost:"+System.getProperty("tomcat.http.port")+"/juzu/assets/plugin/amd/require/assets/bar.js")).trim();
