...
public class RequestFormParamUTF8DefaultEncodingViewServletTestCase extends AbstractRequestFormParamDefaultEncoding {
  ...
  protected void checkEuro(String test) {
    assertEquals(AbstractTestCase.EURO, test);
  }
}
