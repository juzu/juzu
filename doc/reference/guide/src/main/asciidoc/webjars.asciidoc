...
are resolved from a repository. The +@Asset+ annotation is interpolated at compilation time with annotation
 processor options. Therefore it is possible to replace +@Assets(@Asset("jquery/1.10.2/jquery.js"))+
 by +@Assets(@Asset("jquery/${jquery.version}/jquery.js"))+ and provide the +jquery.version=1.10.2+ option
 to the compiler:
