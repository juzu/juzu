...
Obviously Juzu needs to be aware of the existence of this tag, this is achieved using the +@Tag+ annotation:

.Declaring our simple tag
[source,java]
----
@Application(tags = @Tag(name = "mytag", path = "mytag.gtmpl"))
----
