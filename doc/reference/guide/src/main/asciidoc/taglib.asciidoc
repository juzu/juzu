...
application that defined it. A simple tag can be reused by merely declaring it in a _META-INF/services/juzu.template.TagHandler_
file. The corresponding Java class to declare is created by concatenating the application package, the +tags+ name and
