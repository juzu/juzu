...
package org.juzu.tutorial.juzcret.step5;
...
import org.juzu.tutorial.juzcret.step5.services.SecretService;
...
public class JuZcretApplication implements RequestLifeCycle {
  ...
  org.juzu.tutorial.juzcret.step5.templates.secretWall secretWall;
  
  @Inject
  @Path("addSecret.gtmpl")
  org.juzu.tutorial.juzcret.step5.templates.addSecret addSecret;
  
  @Inject
  @Path("editMode.gtmpl")
  org.juzu.tutorial.juzcret.step5.templates.editMode editMode;
