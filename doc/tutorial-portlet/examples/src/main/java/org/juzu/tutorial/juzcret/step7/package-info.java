...
@juzu.Application(defaultController = org.juzu.tutorial.juzcret.step7.JuZcretApplication.class)
@Bindings({ @Binding(value = org.juzu.tutorial.juzcret.step7.services.SecretService.class, implementation = org.juzu.tutorial.juzcret.step7.services.SecretServiceJCRImpl.class),
