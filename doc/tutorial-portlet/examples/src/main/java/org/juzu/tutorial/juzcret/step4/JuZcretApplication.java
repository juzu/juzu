...
import org.juzu.tutorial.juzcret.step4.services.SecretService;
...
public class JuZcretApplication implements RequestLifeCycle {
  ...
  org.juzu.tutorial.juzcret.step4.templates.secretWall secretWall;
  
  @Inject
  @Path("addSecret.gtmpl")
  org.juzu.tutorial.juzcret.step4.templates.addSecret addSecret;
  
  @Inject
  @Path("editMode.gtmpl")
  org.juzu.tutorial.juzcret.step4.templates.editMode editMode;
