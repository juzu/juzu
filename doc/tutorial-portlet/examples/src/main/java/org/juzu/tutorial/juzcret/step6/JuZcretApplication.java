...
public class JuZcretApplication implements RequestLifeCycle {
  ...
  org.juzu.tutorial.juzcret.step6.templates.secretWall secretWall;
  
  @Inject
  @Path("addSecret.gtmpl")
  org.juzu.tutorial.juzcret.step6.templates.addSecret addSecret;
  
  @Inject
  @Path("editMode.gtmpl")
  org.juzu.tutorial.juzcret.step6.templates.editMode editMode;
