...
Let's start by downloading link:http://sourceforge.net/projects/exo/files/Platform4.1/eXo-Platform-community-4.1.0-RC1.zip/download[eXo Platform Community Edition]
