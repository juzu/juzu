...
I remember you that for your next personal project, a [[Juzu PLF 4.1 startup project>>#]] is available.


== Display Secret
Please configure now your project to use link:http://community.exoplatform.com/portal/g/:spaces:juzu/juzu/wiki/Develop_Juzu_Portlet_with_JRebel[Develop Juzu Portlet with JRebel].
Recompile the project:
[source,text]
----
$ mvn clean install
----
Copy/Paste the war +(replace the old one)+ in the webapp folder of PLF server as explain in step 1, start the server and open link:http://localhost:8080/portal/intranet/JuZcret[JuZcret page created in step 1]:
