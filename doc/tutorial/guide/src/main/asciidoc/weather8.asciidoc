...
<2> The _collapse_ jQuery plugin depends on the _transition_ script
<3> Our _weather_ script depends also on the jQuery _collapse_ plugin
...
in the http://twitter.github.com/bootstrap/javascript.html#collapse[Bootstrap manual]. In our case we modify
...
and action controllers, for this use case we will use a new type of controller : the _resource_ controller.
...
[source,java]
----
include::{sourcesdir}/examples/tutorial/weather8/Weather.java[tags=fragment]

include::{sourcesdir}/examples/tutorial/weather8/Weather.java[tags=getFragment]
----
...
[source,java]
----
include::{sourcesdir}/examples/tutorial/weather8/templates/fragment.gtmpl[]
----
...
[source,javascript]
----
include::{sourcesdir}/examples/tutorial/weather8/assets/weather.js[]
----
...
If you take time to read the collapse plugin component http://twitter.github.com/bootstrap/javascript.html#collapse[documentation]
