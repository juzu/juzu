...
[source,java]
----
include::{sourcesdir}/examples/tutorial/weather6/templates/index.gtmpl[]
----
...
[source,java]
----
include::{sourcesdir}/examples/tutorial/weather6/Weather.java[tags=index2]
----
...
[source,java]
----
include::{sourcesdir}/examples/tutorial/weather6/Weather.java[tags=index1]
----
