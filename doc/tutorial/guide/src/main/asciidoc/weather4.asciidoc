...
[source,java]
----
include::{sourcesdir}/examples/tutorial/weather4/Weather.java[tags=index2]
----

The +@Route("/show/{location}")+ annotation binds the the +index+ controller method to the _/show/*_ route.
Since our our application package is annotated with the +@Route("/weather4")+ annotation, an URL like
_/weather4/show/marseille_ invokes this controller method with the _marseille_ location.
...
[source,java]
----
include::{sourcesdir}/examples/tutorial/weather4/templates/index.gtmpl[]
----
...
[source,java]
----
include::{sourcesdir}/examples/tutorial/weather4/Weather.java[tags=index1]
----
...
NOTE: Juzu leverages the http://download.oracle.com/javase/6/docs/technotes/guides/apt/index.html[Annotation Processing Tool]
